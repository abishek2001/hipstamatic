...
function Posts(props) {
    ...
    return (
        <div className='post'>
            ...
            <Avatar className="post_avatar" src="/static/images/avatar/2.jpg" alt="djjdjd"/>
           <h3>{props.username}</h3>
           </div>
           <img className="post_image" src={props.imgURL}
           alt=""/>
           ...
           {props.user && (
               ...
               <input className="post_input" type="text" placeholder="Add a comment.." value={comment} onChange={
